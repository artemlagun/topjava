...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.BY_DATE, query = "SELECT m FROM Meal m WHERE m.user.id=:user_id AND " +
                "m.dateTime >=: start_date_time AND m.dateTime <: end_date_time ORDER BY m.dateTime DESC"),
